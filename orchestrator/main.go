...
var registry = []specialist{
	...
	{"triage", "incident-triage-agent", "http://localhost:8019", "triage", []string{"alert"},
		"triage a production alert, error spike, or stack trace to a likely root cause, severity, and the owning on-call team",
		[]string{"incident", "on-call", "oncall", "pagerduty", "page the", "root cause", "postmortem", "runbook", "escalate", "sev1", "sev2", "who owns this service"}},
