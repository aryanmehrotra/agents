...
var registry = []specialist{
	...
	{"triage", "incident-triage-agent", "http://localhost:8019", "triage", []string{"alert"},
		"triage a production alert / stack trace / on-call page to a likely root cause and owning team",
		[]string{"incident", "alert", "on-call", "oncall", "pagerduty", "stack trace", "root cause", "who owns this"}},
