...
var registry = []specialist{
	{"research", "research-agent", "http://localhost:8008", "research", []string{"question"},
		...
		[]string{"http://", "https://"}},
	{"breaking", "breaking-change-agent", "http://localhost:8019", "breaking-change", []string{"diff"},
		"detect API/contract breaking changes in a diff — removed or resignatured exported symbols, changed fields",
		[]string{"breaking change", "breaking api", "api break", "backwards compatible", "backward compatible", "backwards-incompatible", "contract break", "semver break"}},
