...
var registry = []specialist{
	...
	{"breaking", "breaking-change-agent", "http://localhost:8019", "check", []string{"title", "diff"},
		"check a code diff for breaking API/contract changes before merge (removed symbols, changed types, dropped enum values)",
		[]string{"breaking change", "breaking changes", "breaking api", "api break", "api compatibility", "backwards compatible", "backward compatibility", "contract break"}},
