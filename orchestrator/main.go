...
var registry = []specialist{
	...
	{"breaking", "breaking-change-agent", "http://localhost:8019", "breaking", []string{"text"},
		"detect API/contract breaking changes between an old and new set of endpoints before merge",
		[]string{"breaking change", "breaking changes", "api break", "backward compat", "backwards compat", "contract diff", "api diff", "breaking api"}},
