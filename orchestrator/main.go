...
var registry = []specialist{
	...
	{"breaking", "breaking-change-agent", "http://localhost:8019", "breaking-changes", []string{"text"},
		"detect API/contract breaking changes between an old and new version before merge",
		[]string{"breaking change", "breaking changes", "api break", "contract break", "backwards compatible", "backward compatible", "backwards incompatible", "backward incompatible", "api compatibility"}},
