...
var registry = []specialist{
	...
	{"triage", "incident-triage-agent", "http://localhost:8019", "triage", []string{"text"},
		"triage a production alert/incident and its log lines to a likely root cause, severity, and owning team",
		[]string{"incident", "alert fired", "pagerduty", "on-call", "oncall", "root cause", "postmortem", "runbook", "sev1", "sev2"}},
