...
var registry = []specialist{
	...
	{"release-notes", "release-notes-agent", "http://localhost:8019", "release-notes", []string{"text"},
		"draft release notes / a changelog from a set of merged pull requests",
		[]string{"release notes", "changelog", "change log", "draft the changelog", "merged prs", "what changed in this release", "cut a release", "prepare release notes", "release announcement"}},
