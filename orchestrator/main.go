...
var registry = []specialist{
	...
	{"triage", "incident-triage-agent", "http://localhost:8019", "triage", []string{"alert"},
		"triage an alert / stack trace / production incident to a likely root cause, severity, and owning team to page",
		[]string{"alert", "incident", "stack trace", "on-call", "oncall", "page the", "root cause", "who owns", "5xx", "502", "503", "504", "crashloop", "sev1", "sev2", "pagerduty", "runbook"}},
