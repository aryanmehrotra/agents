module github.com/aryanmehrotra/agents/agents/retrieval/memory-agent

go 1.26.3

require (
	gofr.dev v1.49.1-0.20260724065006-43ffd6c3c075
	gofr.dev/pkg/gofr/datasource/surrealdb v0.3.2-0.20260724065006-43ffd6c3c075
)
...
require (
	...
	github.com/surrealdb/surrealdb.go v1.6.0 // indirect
