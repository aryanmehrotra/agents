...
flowchart TB
    ...
    class D,S,K,R,P,U,Q,W,X,L,SC,SP,ES,SB,MG,TG,FK,RN,WF,ORCH agent;
    class LLM core;
```
...
- **[`release-notes-agent`](agents/sdlc/release-notes-agent)** — merged PRs → a changelog, hallucination-checked + secret-redacted
...
├── sdlc/              code-review · spec · estimation · scaffold · migration · test-gen · flaky-test · release-notes
