...
flowchart TB
    ...
    class D,S,K,R,P,U,Q,W,X,L,SC,SP,ES,SB,MG,TG,FK,IT,WF,ORCH agent;
    class LLM core;
```
...
**🚨 Operate**
- **[`incident-triage-agent`](agents/sdlc/incident-triage-agent)** — alert → root cause, severity & owner; **severity + routing decided in Go**
...
├── sdlc/              code-review · spec · estimation · scaffold · migration · test-gen · flaky-test · incident-triage
