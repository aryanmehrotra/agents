...
flowchart LR
    ...
    subgraph System["GoFr 1.58 multi-agent system"]
        ...
        ORCH -->|"circuit breaker + retry"| W["🌐 research-agent<br/>multi-source research, guardrailed"]
    end
...
| 🌐 **[`research-agent`](research-agent)** | Multi-source web research, answer grounded with citations | fetches caller URLs + deterministic **SSRF guardrail** before any outbound request |
...
├── 🌐 research-agent/   multi-source research + citations, SSRF-guardrailed fetch    :8008
